...
using UnityEngine.SceneManagement;
    ...
    public class TestButton : MonoBehaviour, IInputClickHandler, IFocusable
    {
        ...
        //my variables for button check
        //private AppSceneElements appScene = new AppSceneElements();
        //private bool[] toggleButtonArray;
        ...
        public void OnInputClicked(InputClickedEventData eventData)
        {
            ...
            // my code for calling the repair task scene
            if (gameObject.name == "SaveButton")
            {
                Debug.Log(" calling the repair task scene");
                // load the repair task scene
                SceneManager.LoadSceneAsync("Scenes/RepairTask", LoadSceneMode.Single);
            }
